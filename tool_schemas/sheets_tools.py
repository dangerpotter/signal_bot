"""
Google Sheets tool schemas for Signal bots.

Contains all Google Sheets related tool definitions and categories.
"""
...
# Two-phase meta-tool categories for sheets tools
SHEETS_CATEGORIES = {
    "sheets_core": {
